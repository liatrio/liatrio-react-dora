...
import { defaultMetricThresholdSet, deploymentFrequencyName } from '../src/constants'
...
const Template: StoryFn<ChartProps> = () => {
  ...
  return (
    <div style={{height: "200px", width: "600px", maxWidth: "600px"}}>
      ...
      <br/>
      <br/>
      <DeploymentFrequencyGraph metricThresholdSet={metricThresholdSet} includeWeekendsInCalculations={includeWeekends} graphStart={graphStartDate} graphEnd={graphEndDate} loading={loading} message={message} data={data} />
    </div>
  )
}
